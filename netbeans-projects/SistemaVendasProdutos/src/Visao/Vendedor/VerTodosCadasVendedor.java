...
public class VerTodosCadasVendedor extends JDialog implements ActionListener {
    ...
    public VerTodosCadasVendedor(VendedorControl controle) {
        ...
        tabela.getColumnModel().getColumn(9).setMinWidth(70);
        tabela.getColumnModel().getColumn(10).setMinWidth(100);
        tabela.getColumnModel().getColumn(11).setMinWidth(145);
        tabela.getColumnModel().getColumn(12).setMinWidth(145);
        tabela.getColumnModel().getColumn(13).setMinWidth(100);
        tabela.getColumnModel().getColumn(14).setMinWidth(100);
        tabela.getColumnModel().getColumn(15).setMinWidth(220);
