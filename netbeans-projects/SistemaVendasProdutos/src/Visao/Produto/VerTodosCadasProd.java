...
public class VerTodosCadasProd extends JDialog implements ActionListener {

    private JTextField tfPesquisa;
    private JLabel lbRecebe;
    private JButton btOk;
    private TableModelProd tableModel;
    private RenderizadoraProd rendener;
    private String texto = "", pesquisa = "";
    private JTable tabela;

    public VerTodosCadasProd(ProdutoControl controle) {
        ...
        rendener = new RenderizadoraProd(getTexto(), getPesquisa());
