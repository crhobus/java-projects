...
public class ConsultaSetores extends JDialog implements ActionListener {
    ...
    private TableModelSetor tableModel;
    private SetorControl controle;
    private ListenerSetor listener;
    private int coluna;

    public ConsultaSetores(SetorControl controle) {
        this.controle = controle;
        this.coluna = -1;
        tableModel = new TableModelSetor(controle);
        initComponents();
    }

    private void initComponents() {
        setTitle("Consulta Setores");
        setLayout(null);
        ...
        tabela.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evento) {
                if (evento.getClickCount() == 2) {
                    if (listener != null) {
                        listener.exibeSetor(controle.getListaPosicao(tabela.getSelectedRow()));
                        dispose();
                    }
                }
            }
    ...
    public void setListener(ListenerSetor listener) {
