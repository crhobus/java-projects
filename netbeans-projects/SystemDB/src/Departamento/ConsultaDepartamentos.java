...
public class ConsultaDepartamentos extends JDialog implements ActionListener {
    ...
    private TableModelDepartamento tableModel;
    private DepartamentoControl controle;
    private ListenerDepartamento listener;
    private int coluna;

    public ConsultaDepartamentos(DepartamentoControl controle) {
        this.controle = controle;
        this.coluna = -1;
        tableModel = new TableModelDepartamento(controle);
        initComponents();
    }
        ...
        tabela.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evento) {
                if (evento.getClickCount() == 2) {
                    if (listener != null) {
                        listener.exibeDep(controle.getListaPosicao(tabela.getSelectedRow()));
                        dispose();
                    }
                }
            }
    ...
    public void setListener(ListenerDepartamento listener) {
