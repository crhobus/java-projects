...
public class ConsultaUsuario extends JDialog implements ActionListener {
    ...
    private ListenerUsuario listener;
    private int coluna;

    public ConsultaUsuario(UsuarioControl controle) {
        this.controle = controle;
        this.coluna = -1;
        tableModel = new TableModelUsuario(controle);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tabela.getColumnModel().getColumn(2).setMinWidth(202);
        ...
        tabela.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evento) {
                if (evento.getClickCount() == 2) {
                    if (listener != null) {
                        listener.exibeUsuario(controle.getListaPosicao(tabela.getSelectedRow()));
                        dispose();
                    }
                }
            }
    ...
    public void setListener(ListenerUsuario listener) {
