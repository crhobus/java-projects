...
public class ConsultaPaises extends JDialog implements ActionListener {
    ...
    private TableModelPais tableModel;
    private PaisControl controle;
    private ListenerPais listener;
    private int coluna;

    public ConsultaPaises(PaisControl controle) {
        this.controle = controle;
        this.coluna = -1;
        tableModel = new TableModelPais(controle);
        initComponents();
    }

    private void initComponents() {
        setTitle("Consulta Países");
        setLayout(null);
        ...
        tabela.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evento) {
                if (evento.getClickCount() == 2) {
                    if (listener != null) {
                        listener.exibePais(controle.getListaPosicao(tabela.getSelectedRow()));
                        dispose();
                    }
                }
            }
    ...
    public void setListener(ListenerPais listener) {
