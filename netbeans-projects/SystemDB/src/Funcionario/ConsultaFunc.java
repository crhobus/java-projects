...
public class ConsultaFunc extends JDialog implements ActionListener {
    ...
    private ListenerFunc listener;
    private int coluna;

    public ConsultaFunc(FuncionarioControl controle) {
    ...
    private void initComponents() {
        ...
        tabela.getColumnModel().getColumn(13).setMinWidth(80);
        ...
        tabela.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evento) {
                if (evento.getClickCount() == 2) {
                    if (listener != null) {
                        listener.exibeFunc(controle.getListaPosicao(tabela.getSelectedRow()));
                        dispose();
                    }
                }
            }
    ...
    public void setListener(ListenerFunc listener) {
