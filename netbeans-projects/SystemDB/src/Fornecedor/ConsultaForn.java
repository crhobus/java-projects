...
public class ConsultaForn extends JDialog implements ActionListener {
    ...
    private ListenerForn listener;
    private int coluna;

    public ConsultaForn(FornecedorControl controle) {
    ...
    private void initComponents() {
        ...
        tabela.getColumnModel().getColumn(6).setMinWidth(280);
        ...
        tabela.getColumnModel().getColumn(10).setMinWidth(200);
        tabela.getColumnModel().getColumn(11).setMinWidth(180);
        tabela.getColumnModel().getColumn(12).setMinWidth(300);
        ...
        tabela.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evento) {
                if (evento.getClickCount() == 2) {
                    if (listener != null) {
                        listener.exibeForn(controle.getListaPosicao(tabela.getSelectedRow()));
                        dispose();
                    }
                }
            }
    ...
    public void setListener(ListenerForn listener) {
                ...
                if ("".equals(tfProcura.getText().trim())) {
                    ...
                    try {
                        if (coluna == 0 || coluna == 8) {
                            try {
                                controle.getLista(coluna, "", Integer.parseInt(tfProcura.getText()));
                            } catch (NumberFormatException ex) {
                            }
                        } else {
                            controle.getLista(coluna, tfProcura.getText(), 0);
                        }
