...
public class ConsultaVendas extends JDialog implements ActionListener {
    ...
    private ListenerVendas listener;
    private int coluna;

    public ConsultaVendas(VendasControl controle) {
    ...
    public void setListener(ListenerVendas listener) {
