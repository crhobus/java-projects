...
<html>
    ...
    <body>
        <form id="formIndex" action="servletindex">
            <table id="principal">
                <thead>
                    <tr>
                        ...
                        <th id="cabecalho_p8">
                            <input type="submit" value="Sair" name="bt_sair_index"/>
                        </th>
                        ...
                        <th id="cabecalho_p5">
                            <input type="submit" value="OK" name="bt_ok_index"/>
                        </th>
                        ...
                        <td rowspan="2" colspan="7" id="conteudo_p3">
                            ...
                            <div>
                                ...
                                <div id="conteudo">
                                    <ul id="lista">
                                        <li>
                                            <img src="imagens/index/index1.png" />
                                        </li>
                                        <li>
                                            <img src="imagens/index/index2.png" />
                                        </li>
                                        <li>
                                            <img src="imagens/index/index3.png" />
                                        </li>
                                        <li>
                                            <img src="imagens/index/index4.png" />
                                        </li>
                                        <li>
                                            <img src="imagens/index/index5.png" />
                                        </li>
                                        <li>
                                            <img src="imagens/index/index6.png" />
                                        </li>
                                    </ul>
                                </div>
