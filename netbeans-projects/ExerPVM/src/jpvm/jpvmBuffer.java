...
class jpvmBufferElementContents implements Serializable {
    ...
    public jpvmBufferElementContents(int d[], int n, int stride, boolean inPlace) {
        init();
    ...
    public jpvmBufferElementContents(float d[], int n, int stride, boolean inPlace) {
        init();
    ...
    public jpvmBufferElementContents(double d[], int n, int stride, boolean inPlace) {
        init();
    ...
    public jpvmBufferElementContents(byte d[], int n, int stride, boolean inPlace) {
        init();
    ...
    public void unpack(jpvmTaskId d[], int n, int stride) throws jpvmException {
...
public class jpvmBuffer {
    ...
    public void recv(jpvmRecvConnection conn) throws jpvmException {
        ...
        try {
            N = strm.readInt();
            jpvmDebug.note("jpvmBuffer, recv " + N + " buffer elements.");
            for (i = 0; i < N; i++) {
