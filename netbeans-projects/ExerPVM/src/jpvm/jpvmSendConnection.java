...
public class jpvmSendConnection {
    ...
    public static jpvmSendConnection connect(jpvmTaskId t, jpvmTaskId f) throws jpvmException {
        jpvmSendConnection ret = null;
        try {
            jpvmDebug.note("jpvmSendConnection, " + "connecting to " + t.toString());
            ...
            throw new jpvmException("jpvmSendConnection, connect - " + " i/o exception: \"" + ioe + "\"");
        }
        return ret;
    }
};
