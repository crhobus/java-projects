...
public class ConsultaBairro extends JDialog implements ActionListener {
    ...
    public ConsultaBairro(BairroDAO bairroDAO) {
        this.bairroDAO = bairroDAO;
        this.coluna = -1;
        tableModel = new TableModelBairro(bairroDAO);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tabela.getColumnModel().getColumn(2).setMinWidth(242);
        ...
        tabela.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evento) {
                if (evento.getClickCount() == 2) {
                    if (listener != null) {
                        listener.exibeBairro(bairroDAO.getBairroMapa(tabela.getSelectedRow()));
                        dispose();
                    }
                }
            }
            ...
            if ("".equals(lbNomeColuna.getText())) {
                ...
                if ("".equals(tfProcura.getText().trim())) {
                    ...
                    try {
                        if (coluna == 0) {
                            try {
                                bairroDAO.listBairrosCondicao(coluna, "", Integer.parseInt(tfProcura.getText()));
                            } catch (NumberFormatException ex) {
                            }
                        } else {
                            bairroDAO.listBairrosCondicao(coluna, tfProcura.getText(), 0);
                        }
