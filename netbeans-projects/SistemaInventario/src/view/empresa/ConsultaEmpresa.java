...
public class ConsultaEmpresa extends JDialog implements ActionListener {
    ...
    private TableModelEmpresa tableModel;
    private EmpresaDAO empresaDAO;
    private ListenerEmpresa listener;
    private int coluna;

    public ConsultaEmpresa(EmpresaDAO empresaDAO) {
        this.empresaDAO = empresaDAO;
        this.coluna = -1;
        tableModel = new TableModelEmpresa(empresaDAO);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tabela.getColumnModel().getColumn(9).setMinWidth(350);
        ...
        tabela.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent evento) {
                if (evento.getClickCount() == 2) {
                    if (listener != null) {
                        listener.exibeEmpresa(empresaDAO.getEmpresaMapa(tabela.getSelectedRow()));
                        dispose();
                    }
                }
            }
    ...
    public void setListener(ListenerEmpresa listener) {
                ...
                if ("".equals(tfProcura.getText().trim())) {
                    ...
                    try {
                        if (coluna == 0 || coluna == 6) {
                            try {
                                empresaDAO.listEmpresasCondicao(coluna, "", Integer.parseInt(tfProcura.getText()));
                            } catch (NumberFormatException ex) {
                            }
                        } else {
                            empresaDAO.listEmpresasCondicao(coluna, tfProcura.getText(), 0);
                        }
