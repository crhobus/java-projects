package seguranca.criptografiaAssimetrica;
...
public class CifraRSA {
    ...
    public static void main(String args[]) throws Exception {
        ...
        //saídas do exemplo        
        System.out.println("tamanho Publica: " + chaves.getPublic().getEncoded().length);
        System.out.println("tamanho Privada: " + chaves.getPrivate().getEncoded().length);
