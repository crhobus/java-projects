...
public class VerTodosCadas extends JDialog implements ActionListener {
    ...
    public VerTodosCadas(EmpresaControl controle) {
        ...
        tabela.getColumnModel().getColumn(9).setMinWidth(130);
        tabela.getColumnModel().getColumn(10).setMinWidth(115);
        tabela.getColumnModel().getColumn(11).setMinWidth(115);
        tabela.getColumnModel().getColumn(12).setMinWidth(220);
        tabela.getColumnModel().getColumn(13).setMinWidth(700);
