...
public class VerTodosCadas extends JDialog implements ActionListener {
    ...
    public VerTodosCadas(FornecedorControl controle) {
        ...
        tela.add(painel);
        painel.setBorder(BorderFactory.createTitledBorder("Fornecedores"));
        ...
        tabela.getColumnModel().getColumn(8).setMinWidth(150);
        tabela.getColumnModel().getColumn(9).setMinWidth(100);
        tabela.getColumnModel().getColumn(10).setMinWidth(140);
        tabela.getColumnModel().getColumn(11).setMinWidth(140);
        ...
        tabela.getColumnModel().getColumn(15).setMinWidth(230);
