...
public class VerTodosCadasClie extends JDialog implements ActionListener {
    ...
    public VerTodosCadasClie(ClienteControl controle) {
    ...
    public void actionPerformed(ActionEvent evvento) {
