...
public class VerTodosPag extends JDialog implements ActionListener {
    ...
    public VerTodosPag(PagamentosControl controle) {
        setTitle("Pagamentos Cadastrados");
        ...
        lbRecebe.setBounds(150, 30, 150, 14);
        ...
        tabela.getColumnModel().getColumn(9).setMinWidth(115);
