...
public class PesquisaUsuario extends JDialog implements ActionListener {
    ...
    private void initComponents(UsuarioControl controle) {
        ...
        tabela.getColumnModel().getColumn(1).setMinWidth(112);
