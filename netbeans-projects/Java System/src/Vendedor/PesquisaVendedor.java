...
public class PesquisaVendedor extends JDialog implements ActionListener {
    ...
    public PesquisaVendedor(VendedorControl controle) {
        tableModel = new TableModel(controle);
        rendener = new Renderizadora(texto, pesquisa);
        initComponents(controle);
    }

    private void initComponents(VendedorControl controle) {
        ...
        tabela.getColumnModel().getColumn(3).setMinWidth(310);
