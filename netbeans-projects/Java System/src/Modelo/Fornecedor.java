...
public class Fornecedor {
    ...
    private String nome, sigla, nomeFantasia, inscricaoEstadual, cnpj,
            inscricaoMunicipal, tipoPessoa, contribuinte, exportador,
            tipoFornecedor, empresa, foneEmpresa, banco, agencia, conta,
            caixaPostal, endereco, bairro, cidade, estado, regiao, pais, cep,
            referencia, fone, celular1, celular2, fax, email, msn, skype,
            descricao, homePage, observacoes;
