...
public class Fornecedor {
    ...
    private int codigo, digitoConta, numero;
    private String nome, sigla, nomeFantasia, ie, cnpj, inscricaoMunicipal,
            tipoPessoa, contribuinte, exportador, tipoFornecedor, empresa,
            foneEmpresa, banco, agencia, conta, caixaPostal, endereco, bairro,
            cidade, uf, regiao, pais, cep, referencia, fone, celular1,
            celular2, fax, email, msn, skype, descricao, homePage, observacoes;
    private Date dataCadas, ultAlteracao;
    private double comissao, compraMinima, compraMaxima, valorFrete, icms,
            cofins, ipi, juros, descontos;
